    ...
    <div class="container text-center text-md-left mt-5" style="margin-top:10px;">
      ...
      <div class="row mt-3">
        ...
        <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4 mt-5">
          ...
          <p>POA(Pot Of Ambition)</p>
          <p>Cooperation with SSAFY</p>
        </div>
        <!-- Grid column -->
        ...
        <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4 mt-5">
          ...
          <hr class="deep-purple accent-2 mb-4 mt-0 d-inline-block mx-auto" style="width: 60px;" />
          <p>
            <i class="fas fa-home mr-3"></i> 대전, 삼성화재연수원, 한국
          </p>
          <p>
            <i class="fas fa-envelope mr-3"></i> bigtiger1454@gmail.com
          </p>
          <p>
            <i class="fas fa-phone mr-3"></i> + 82 010 3481 0904
          </p>
          <p>
            <i class="fas fa-print mr-3"></i> + 82 010 1234 1234
          </p>
        </div>
        <!-- Grid column -->
      </div>
